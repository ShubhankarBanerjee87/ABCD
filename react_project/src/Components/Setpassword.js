...
function Setpassword() {
    ...
    function getNext() {
        ...
        if(password === '')
        {
            ...
            SaveToLocalStorage();
            // Assume you save the password here (you can add your logic)
            ...
            setTimeout(() => {
                navigate('/create/choose-network');
            }, 4000);
            ...
            <div className="setPassword-backcard">
                <div><button type="button" className="create-backButton" onClick={getBack} ><img src={Back} alt="back" className="create-backButton" /></button>
                    <div className="progress-bar">
                        ...
                        <div id="4" className="progress "></div>
                    </div>
                </div>
                ...
                <div><h2 className="create-center-align">Create Password</h2>
                    <div className="setPasword-password-block ">
                        ...
                        <div className="setPassword-password-flex ">
                            <label for="password" className="label-width"><b> Password</b></label>
                            <input type="password" value={password} onChange={handlePasswordChange} id="password" className="setPasword-password-box "></input>
                        </div>
                        ...
                        <div className="confirmPassword setPassword-password-flex mt-5">
                            <label for="confirm-password" className="label-width"><b>Verify Password</b></label>
                            <input type="password" value={confirPassword} onChange={handleConfirmPasswordChange} id="confirm-password" className="setPasword-password-box" disabled={isDisabled}></input>
                        </div>
                        <div className={`${!showError ? 'display-none' : ''} display-red center-align mt-2`}>Password not verified</div>
                    </div>
